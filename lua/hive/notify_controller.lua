...
local sys_notify = require("hive.utils.sys_notify")
...
function NotifyController:setup_focus_tracking()
  ...
  self.aug = api.nvim_create_augroup("HiveNotifyFocus", { clear = true })
...
---@return Hive.NotifyController|nil
function M.instance()
  return _instance
end
