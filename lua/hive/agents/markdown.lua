...
---@class Hive.MarkdownAgent
---@field name string
---@field type? Hive.AgentType
---@field description? string
---@field tools? string[]
---@field permissions? Hive.AgentPermissions
---@field system_prompt? string
---@field opts? Hive.AgentOpts
...
---@param dir string
---@return table<string, Hive.MarkdownAgent>
...
function M.register_from_dir(dir)
  ...
  local agents_module = require("hive.agents")
