--[[
Context pruning engine for Hive chat history
Original architecture for pruning tool output while preserving conversational state
...
local function _debug(msg)
  require("hive.debug").log("prune", msg)
end
