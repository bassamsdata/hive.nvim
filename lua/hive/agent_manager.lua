...
---@field entries Hive.HubEntry[] Flat navigable list
...
function ChatHub:_discover_chats()
  ...
  local hierarchy_ok, hierarchy = pcall(require, "hive.agents.hierarchy")
...
---@return Hive.HubSegment[] header_segments
---@return Hive.HubSegment[] status_segments
...
---@param segments Hive.HubSegment[]
---@return string
