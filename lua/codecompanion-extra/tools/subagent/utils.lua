...
---Fire a CCExtra-prefixed autocmd event
---All extension events use the "CCExtra" prefix to avoid conflicts with core CodeCompanion events.
---@param event string Event name suffix (e.g. "SubagentStarted" fires "CCExtraSubagentStarted")
---@param data? table Event data payload
function M.fire(event, data)
  api.nvim_exec_autocmds("User", {
    pattern = "CCExtra" .. event,
    data = data or {},
  })
end
