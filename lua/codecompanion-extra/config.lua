...
local function _default_keymaps(p)
  return {
    ...
    extra_keymap_help = { modes = { n = p .. "?" }, desc = "Extra keymap reference" },
  }
end
...
---@field debug? CodeCompanionExtra.DebugConfig Debug logging configuration
...
---@field keymap? table<string, CodeCompanionExtra.KeymapEntry|string> Keymap configuration. Keys are keymap names, values are { modes, desc } entries. 'prefix' is a string.
...
---@class CodeCompanionExtra.DebugConfig
...
---Get the keymap prefix for extra chat keymaps
---@return string
