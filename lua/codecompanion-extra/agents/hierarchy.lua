...
---@class CodeCompanionExtra.ToolProgress
...
---@class CodeCompanionExtra.Session
...
---@field agent_type CodeCompanionExtra.AgentType
...
---@field tool_progress table<string, CodeCompanionExtra.ToolProgress> Tool execution tracking by tool call id
...
---@type table<number, CodeCompanionExtra.Session>
M._sessions = {}
...
---@param args { bufnr: number, parent_bufnr?: number, agent_name: string, agent_type: CodeCompanionExtra.AgentType, description?: string, hidden?: boolean }
---@return CodeCompanionExtra.Session
...
---@param bufnr number
---@return CodeCompanionExtra.Session|nil
