...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: View on GitHub
      link: https://github.com/bassamsdata/hive.nvim
...
features:
  ...
  - icon: 🛠️
    ...
    details: Diagnostics, task delegation, expert consultation, interactive forms, todo tracking, pruning, swarm orchestration, and more.
---
